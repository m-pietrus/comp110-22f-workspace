...
if len(word) == 5:
    ...
    if len(letter) == 1:
        ...
        if letter == word[4]:
            ...
            match = match + 1
        if match == 0:
            print("No instances found of " + letter + " in " + word)
        if match == 1:
            print("1 instance found of " + letter + " in " + word)
        if match == 2:
            print("2 instances found of " + letter + " in " + word)
        if match == 3:
            print("3 instances found of " + letter + " in " + word)  
        if match == 4:
            print("4 instances found of " + letter + " in " + word)  
        if match == 5:
            print("5 instances found of " + letter + " in " + word)                
    else:
